...
class Combat(Fichier):
    ...
    def display(self):
        ...
        label_name_player = tk.Label(canvas_Element_player,text="Name : {}".format(self.pockemone_player.get_name()),bg="#c2d4f6",font=('times new roman',14))
        label_name_player.place(x=10,y=30)
        
        label_puissance_attak_player = tk.Label(canvas_Element_player,bg="#c2d4f6",text="Puissance d'attaque : {}".format(self.pockemone_player.get_puissance_attaque()),font=('times new roman',14))
        label_puissance_attak_player.place(x=10,y=50)
        
        label_puissance_defence_player = tk.Label(canvas_Element_player,bg="#c2d4f6",text="Puissance de defence: {}".format(self.pockemone_player.get_defence()),font=('times new roman',14))
        ...
        label_name_ordinateur = tk.Label(canvas_Element_ordinateur,text="Name : {}".format(self.pockemone_ordinateur.get_name()),bg="#c2d4f6",font=('times new roman',14))
        ...
        if(not self.__est_vivant(self.pockemone_ordinateur) or not self.__est_vivant(self.pockemone_player)):
            label_win = tk.Label(self.fenetre,text="le gagnant est : {}".format(self.get_name_winner()),font=("times new roman",15))
            label_win.place(x=30,y=200)
            
            label_win = tk.Label(self.fenetre,text="le perdant est : {}".format(self.get_name_loser()),font=("times new roman",15))
            label_win.place(x=30,y=220)
